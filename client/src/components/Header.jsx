        ...
        <header className="Header">
            ...
            <div className="menu-icon">
                <button className="fimenu" onClick={ () => {setMenu(!isMenu)}}>
                    ...
                    {isMenu ? (
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" border="none" outline="none">
