...
node config/setup-environment.js

# Apply safe enhancements
echo -e "\n📋 Applying safe enhancements..."
node config/safe-enhance.js
node init-safe-enhancements.js

# Verify integration
echo -e "\n📋 Verifying integration..."
if node config/verify-integration.js; then
    echo -e "\n✅ Integration verified successfully!"
else
    echo -e "\n❌ Integration verification failed. Please fix the issues above and try again."
    echo "   You can manually run 'node config/verify-integration.js' to check for issues."
    exit 1
fi
...
echo -e "\nFor more information, see docs/integration/GUIDE.md" 